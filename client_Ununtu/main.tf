...
output "instance_public_ip" {
  ...
  value       = [aws_instance.client_ubuntuOS[*].public_ip]
}

output "instance_id" {
  description = "The instance IDs of the EC2 instances"
  value       = [aws_instance.client_ubuntuOS[*].id]
}

output "instance_private_ip" {
  description = "The private IP addresses of the EC2 instances"
  value       = [aws_instance.client_ubuntuOS[*].private_ip]
}



resource "aws_instance" "client_ubuntuOS" {
